...
import { X, Mail, Lock, LogIn, UserPlus, Github, ArrowLeft, Facebook } from 'lucide-react';
      ...
      {isOpen && (
        ...
        >
          ...
          >
            <button
              onClick={handleClose}
              className="absolute top-4 right-4 p-2 text-sage-400 hover:text-sage-600 dark:hover:text-sage-200 hover:bg-sage-50 dark:hover:bg-neutral-800 rounded-full transition-colors"
            >
              <X size={20} />
            </button>
